...
/obj/machinery/intercom/New(loc, dir, building)
...
/obj/machinery/intercom/attack_ai(mob/user as mob)
	src.add_fingerprint(user)
	spawn (0)
		attack_self(user)

/obj/machinery/intercom/attack_paw(mob/user as mob)
	return src.attack_hand(user)

/obj/machinery/intercom/attack_hand(mob/user as mob)
	src.add_fingerprint(user)
	spawn (0)
		attack_self(user)

/obj/machinery/intercom/receive_range(freq, level)
	if (!on)
		return -1
	if(!(0 in level))
...
/obj/machinery/intercom/hear_talk(mob/M as mob, msg)
	if(!src.anyai && !(M in src.ai))
		return
	..()

/obj/machinery/intercom/process()
...
/obj/machinery/intercom/attackby(obj/item/W as obj, mob/user as mob, params)
	src.add_fingerprint(user)
